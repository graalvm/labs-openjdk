...
nmethod::oops_do_mark_link* nmethod::oops_do_try_claim_strong_done() {
  ...
  oops_do_mark_link* old_next = Atomic::cmpxchg(_oops_do_mark_link_addr(), mark_link(nullptr, claim_weak_request_tag), mark_link(this, claim_strong_done_tag));
  if (old_next == nullptr) {
...
nmethod::oops_do_mark_link* nmethod::oops_do_try_add_strong_request(nmethod::oops_do_mark_link* next) {
  ...
  oops_do_mark_link* old_next = Atomic::cmpxchg(_oops_do_mark_link_addr(), next, mark_link(this, claim_strong_request_tag));
  if (old_next == next) {
...
bool nmethod::oops_do_try_claim_weak_done_as_strong_done(nmethod::oops_do_mark_link* next) {
  ...
  oops_do_mark_link* old_next = Atomic::cmpxchg(_oops_do_mark_link_addr(), next, mark_link(extract_nmethod(next), claim_strong_done_tag));
  if (old_next == next) {
