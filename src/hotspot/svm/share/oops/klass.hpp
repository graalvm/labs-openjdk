...
class Klass {
 public:
  ...
  oop java_mirror() { return cast_to_oop(this); }
 ...
 public:
  ...
  static const int _lh_array_tag_primitive_value = ~0x00;
  static const int _lh_array_tag_object_value    = ~0x01;
  ...
  static bool layout_helper_is_objArray(jint lh) {
    return (jint)lh < (jint)((juint)_lh_array_tag_primitive_value << _lh_array_tag_shift);
  }
