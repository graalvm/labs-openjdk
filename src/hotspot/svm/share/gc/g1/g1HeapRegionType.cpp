...
bool G1HeapRegionType::is_valid(Tag tag) {
  switch (tag) {
    ...
    case OldTag:
    case OpenImageHeapTag:
    case OpenImageHeapStartsHumongousTag:
...
const char* G1HeapRegionType::get_str() const {
  ...
  switch (_tag) {
    ...
    case OpenImageHeapTag:                     return "OI";
    case OpenImageHeapStartsHumongousTag:      return "OIHS";
    case OpenImageHeapContinuesHumongousTag:   return "OIHC";
...
G1HeapRegionTraceType::Type G1HeapRegionType::get_trace_type() {
  ...
  switch (_tag) {
    ...
    // The following types are only used during initialization. So, they cannot be encountered by the tracing.
    case ClosedImageHeapTag:
    case OpenImageHeapTag:
    case OpenImageHeapStartsHumongousTag:
    case OpenImageHeapContinuesHumongousTag:
